                    ...
                    if message_text in shuttle_command_names:
                        ...
                        # Configure to tell you schedule at Campus
                            ...
                            if my_day=="Saturday" or my_day=="Sunday":
                                times_campus = [700,800,830,900,930,1000,1030,1100,1130,1200,1230,1300,1400,1500,1600,1700,1800,1830,1900,1930,2000,2100,2200,-1]
                            elif my_day=="Friday":
                                times_campus = [630,645,700,730,800,830,900,1000,1100,1200,1300,1400,1500,1600,1700,1720,1740,1800,1830,1900,2000,2100,2200,-1]
                            else:
                                times_campus = [630,645,700,730,800,830,900,1000,1100,1200,1300,1400,1500,1600,1700,1720,1740,1800,1830,1900,2000,2100,2200,-1]
                        ...
                        # Configure to tell you schedule at Jahangirpuri Metro Station
                            ...
                            # Make list with times of shuttles
                            if my_day=="Saturday" or my_day=="Sunday":
                                times_metro = [800,900,930,1000,1030,1100,1200,1230,1300,1400,1500,1600,1700,1800,1900,1930,2000,2030,2100,2130,2200,2245,2300,-1]
                            elif my_day=="Friday":
                                times_metro = [730,800,830,900,920,940,1000,1100,1200,1300,1400,1500,1600,1700,1800,1830,1900,1930,2000,2100,2130,2200,2245,2300,-1]
                            else:
                                times_metro = [730,800,830,900,920,940,1000,1100,1200,1300,1400,1500,1600,1700,1800,1830,1900,1930,2000,2100,2130,2200,2245,2300,-1]
